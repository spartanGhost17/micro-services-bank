...
import static com.eazybytes.cards.constants.CardsConstants.EAZYBANK_CORRELATION_ID;
...
public class CardsController {
    ...
    public ResponseEntity<CardsDto> fetchCardDetails(@RequestHeader(EAZYBANK_CORRELATION_ID) String correlationId,
                                                        ...
                                                        @Pattern(regexp="(^$|[0-9]{10})",message = "Mobile number must be 10 digits")
                                                        String mobileNumber) {
        logger.debug("fetchCardDetails method start"); //open telemetry will attach distributed tracing
    ...
    @Operation(
            ...
            description = "Get Build information for accounts microservices"
    )
    @ApiResponses({
            @ApiResponse(
                    responseCode = "200",
    ...
    @Operation(
            ...
            description = "Get Java version for accounts microservices"
    )
    @ApiResponses({
            @ApiResponse(
                    responseCode = "200",
